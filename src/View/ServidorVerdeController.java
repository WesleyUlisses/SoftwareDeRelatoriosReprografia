 ...
 * @author mafxr
 */
public class ServidorVerdeController implements Initializable {
    ...
    void irProximo(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("ServidorVerde2.fxml"));
